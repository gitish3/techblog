...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0" nonce="tfXmrfyD"></script>
...
<p class="post-user-info"> <%= ud.getUserByUserId(p.getUserId()).getName() %> has posted it on :</p>
...
<div class="card-footer primary-background">
<div class="fb-comments" data-href="http://localhost:8081/TechBlog/show_blog_page.jsp?post_id=<%= p.getPid() %>" data-numposts="5" data-width=""></div>
